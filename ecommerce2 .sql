...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Abr-2021 às 19:45
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_products_save` (IN `pidproduct` INT(11), IN `pdesproduct` VARCHAR(64), IN `pdescriproduct` TEXT CHARSET utf8mb4, IN `pvlprice` DECIMAL(10,2), IN `pvlwidth` DECIMAL(10,2), IN `pvlheight` DECIMAL(10,2), IN `pvllength` DECIMAL(10,2), IN `pvlweight` DECIMAL(10,2), IN `pdesurl` VARCHAR(128))  BEGIN
    ...
    ELSE
		...
		INSERT INTO tb_products (desproduct, descriproduct, vlprice, vlwidth, vlheight, vllength, vlweight, desurl) 
        VALUES(pdesproduct, pdescriproduct, pvlprice, pvlwidth, pvlheight, pvllength, pvlweight, pdesurl);
...
(1, 1, 'admin', '$2y$12$3NFuFsq.I2/.OR1AX5MzBemd53XJoiMNiEhvrEdxEsHgdnJURZdL6', 1, '2017-09-29 14:49:52');
