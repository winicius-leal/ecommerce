...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>LEAL</strong><br>
                Rua Dr Gil Lino, 250 - Coimbra<br>
                Goiânia - GO<br>
                Telefone: (62) 98330-1924<br>
                E-mail: leal@gmail.com.br
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>R$<?php echo formatarPreco($order["vltotal"]); ?></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
        ...
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <tbody><tr>
                    ...
                    <td>R$<?php echo formatarPreco($cart["vlsubtotal"]); ?></td>
                </tr>
                <tr>
                    <th>Frete:</th>
                    <td>R$<?php echo formatarPreco($cart["vlfreight"]); ?></td>
                </tr>
                <tr>
                    <th>Total:</th>
                    <td>R$<?php echo formatarPreco($cart["vltotal"]); ?></td>
                </tr>
                </tbody></table>
            </div>
            </div>
