...
<script>
    ...
    scripts.push(function(){
                ...
                PagSeguroDirectPayment.getBrand({
                    ...
                    success: function(response) {
                        ...
                        PagSeguroDirectPayment.getInstallments({
                            amount: parseFloat("<?php echo htmlspecialchars( $order["vltotal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"),
                            maxInstallmentNoInterest: parseInt("<?php echo htmlspecialchars( $pagseguro["maxInstallmentNoInterest"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"), //max sem juros
        ...
        $("#form-boleto").on("submit", function(e){ //evento do click no submit do formulario boleto

            e.preventDefault();//desabilita o comportamento padrao do submit
            ...
            //coletar os dados do formulario e jogar em um array params
        ...
        $("#form-credit").on("submit", function(e){
            ...
            PagSeguroDirectPayment.createCardToken({
                ...
                success: function(response) {// Retorna o cartão tokenizado.
