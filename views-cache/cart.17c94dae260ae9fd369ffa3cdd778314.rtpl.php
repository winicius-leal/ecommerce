                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <a title="Remover este item" class="remove" href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove">X</a> 
                                        </td>

                                        <td class="product-thumbnail">
                                            <a href="/product/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo htmlspecialchars( $value1["namephoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></a>
                                        </td>
                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cross-sells">
                                    ...
                                    <div class="coupon">
                                        ...
                                        <input type="text" placeholder="00000-000" value="<?php echo htmlspecialchars( $cart["deszipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" id="cep" class="input-text" name="zipcode" disabled="true">
                                        <input type="submit" formmethod="post" formaction="/cart/freight" value="CÁLCULAR" class="button" disabled="true">
                                        <label class="text-vermelho">O envio do produto ocorre por meios digitais</label>
                                    </div>
